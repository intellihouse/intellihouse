...
@Queries({
	@Query(name="getPvStatusEntity_deviceName_measured", value="SELECT UNIQUE WHERE this.deviceName == :deviceName && this.measured == :measured")
})
public class PvStatusEntity extends Entity {
