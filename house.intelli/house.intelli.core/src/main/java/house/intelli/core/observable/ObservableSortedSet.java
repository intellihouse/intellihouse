...
public class ObservableSortedSet<E> extends ObservableSet<E> implements SortedSet<E> {
     ...
     */
    public static <E> ObservableSortedSet<E> decorate(final SortedSet<E> set) {
        return new ObservableSortedSet<E>(set, null);
    }
     ...
     */
    public static <E> ObservableSortedSet<E> decorate(
	...
	public SortedSet<E> subSet(E fromElement, E toElement) {
        SortedSet<E> subSet = getSortedSet().subSet(fromElement, toElement);
        return new ObservableSortedSet<E>(subSet, getHandler().createSubSetHandler(fromElement, toElement));
    }

    @Override
	public SortedSet<E> headSet(E toElement) {
        SortedSet<E> headSet = getSortedSet().headSet(toElement);
        return new ObservableSortedSet<E>(headSet, getHandler().createHeadSetHandler(toElement));
    }

    @Override
	public SortedSet<E> tailSet(E fromElement) {
        SortedSet<E> tailSet = getSortedSet().tailSet(fromElement);
        return new ObservableSortedSet<E>(tailSet, getHandler().createTailSetHandler(fromElement));
    }
