...
import house.intelli.core.util.Base64Url;
 ...
 */
@XmlJavaTypeAdapter(type=Uid.class, value=Uid.UidXmlAdapter.class)
public class Uid implements Comparable<Uid>, Serializable {
	public static class UidXmlAdapter extends XmlAdapter<String, Uid> {
		@Override
