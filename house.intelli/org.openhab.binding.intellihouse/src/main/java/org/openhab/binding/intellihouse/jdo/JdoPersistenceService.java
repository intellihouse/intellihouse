...
public class JdoPersistenceService {

    private final Logger logger = LoggerFactory.getLogger(JdoPersistenceService.class);
    ...
    protected void start() throws Exception {
        ...
        persistenceProperties.put("javax.jdo.PersistenceManagerFactoryClass", org.datanucleus.api.jdo.JDOPersistenceManagerFactory.class.getName());
        persistenceProperties.put("datanucleus.plugin.pluginRegistryClassName", org.datanucleus.plugin.OSGiPluginRegistry.class.getName());
...
//        logger.info("<<<<<<<<<<<<<<<<<<<<");
    ...
    protected CombiClassLoader createCombiClassLoader() {
        ...
        bundleClassLoaders.add(JdoPersistenceService.class.getClassLoader());
